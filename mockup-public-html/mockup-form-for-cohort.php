				...
				<form class="form-horizontal">
					<div class="form-group">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="cohortId" class="form-control" id="cohortId" placeholder="CohortId">
							</div>
						</div>
						<div class="form-group">
							<label for="cohorteName" class="col-sm-4 control-label">Cohort Name</label>
							<div class="col-sm-10">
								<input type="cohortName" class="form-control" id="inputCohorteName" placeholder="Cohort Name">
						</div>
						</div>
